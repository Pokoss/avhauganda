...
function Footer() {
  return (
    <div className="bg-green-900 px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full  md:px-24 lg:px-8">
      <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        <div className="sm:col-span-2">
          ...
          >
            ...
            <img className='h-20 w-20' src='/Images/logo.jpg'/>
            </div>
        ...
        <div className="space-y-2 text-sm">
          ...
          <div className="flex">
            ...
            <a
              ...
              title="Our phone"
              className="transition-colors duration-300 text-gray-100 hover:text-deep-purple-100"
            >
              +256 756 777 995
            </a>
          </div>
